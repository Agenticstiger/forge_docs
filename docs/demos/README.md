...
The 5 casts below pair with the [See it run](/see-it-run.html) page — each tells a story (problem → CLI flow → punchline) at ~30-50 seconds with takeaway numbers.
