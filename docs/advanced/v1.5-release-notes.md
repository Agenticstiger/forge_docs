...
This page is the changelog for the
`feat/forge-cli-staged-data-model-v1-v2` branch in the forge-cli
repo. It covers V1.5 (catalog integration) and the V2 polish
items shipped alongside.

> **Audience:** anyone reviewing the branch, anyone planning to
> upgrade, anyone auditing what's new.
...
Full sweep result on the branch as of this writing:
...
which means **all entries cached before this branch are
