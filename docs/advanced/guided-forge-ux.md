...
::: tip Where this fits
This page covers the forge UX as it ships in 0.8.7 — 5-mode picker, slash commands, preview panel, streaming contract preview. Pre-0.8.3 releases had the older single-shot interview shape.
:::
