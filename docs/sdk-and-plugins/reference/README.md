...
| [Entry points](./entry-points.md) | Wiring your plugin into the CLI. The entry-point groups (CLI hooks + role-level, all wired as of 0.10.0), their signatures, failure model. |
