...
::: tip See it run
The 60-second [Fluid Forge in action](/forge_docs/see-it-run.html#the-60-second-walkthrough) reel walks this exact flow against four providers (Anthropic Haiku 4.5, OpenAI gpt-4.1-mini, Gemini 2.5-flash, local Ollama gemma4) — every token count is captured live.
:::
